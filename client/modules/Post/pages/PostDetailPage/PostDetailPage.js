...
// Import Actions
import { fetchPost, editPostRequest, thumbUpRequest, thumbDownRequest, thumbUp, thumbDown } from '../../PostActions';
...
export class PostDetailPage extends React.Component {
  ...
  handleVoteUp = () => this.props.thumbUpRequest(this.props.params.cuid, (this.props.post.voteCount || 0) + 1);

  handleVoteDown = () => this.props.thumbDownRequest(this.props.params.cuid, (this.props.post.voteCount || 0) - 1);
...
function mapDispatchToProps(dispatch, props) {
  return {
    ...
    thumbUpRequest: (cuid, newVote) => dispatch(thumbUpRequest(cuid, newVote)),
    thumbDownRequest: (cuid, newVote) => dispatch(thumbDownRequest(cuid, newVote)),
  };
}
